...
To build the final jar and optimize the jhipsterforsearch application for production, run:
...
Then navigate to [http://localhost:30303](http://localhost:30303) in your browser.
